...
- Verified Alliances & Partnerships:
  ...
  * Brand Ambassador & Promos: Done campaigns for Bybit (global crypto exchange), Ehud AI, HuluPay (fintech represented by Sarah K.), LinkPay (virtual crypto USD card), Hulugram (multipurpose super-app built on the Telegram messaging API), Shine Vision (comprehensive eye medical and eyeglass/lens treatments), Ethiopian Blockchain Week (EBW - premier Web3 & digital innovation event), and corporate collaborations with Auction Ethiopia (managed with Yoseph and Zelalem) to optimize digital spend and regional reach.
