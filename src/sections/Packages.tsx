  ...
  return (
    <section id="packages" className="py-24 px-6 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
               ...
               >
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-col gap-0">
                    ...
                    <div className="text-[12px] font-medium text-white/40 tracking-tight">
                      ≈ ${usdPrice.toLocaleString()} USD
                    </div>
                  </div>
                  <p className="text-[10px] text-white/40 mt-3 leading-relaxed font-light">
                    {pkg.description}
                  </p>
                </div>
        ...
        >
          <p className="text-[9px] text-white/20 font-light flex items-center justify-center gap-2">
            Pricing adjusted for global scale.
            <span className="text-brand-purple/60 tracking-wider">INDEX: 1 USD = 180 ETB</span>
          </p>
        </motion.div>
      </div>
    </section>
