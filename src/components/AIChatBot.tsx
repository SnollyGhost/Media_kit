...
- Verified Alliances & Partnerships:
  ...
  * Brand Ambassador & Promos: Done campaigns for Bybit (global crypto exchange), Ehud AI, HuluPay (fintech represented by Sarah K.), LinkPay (virtual crypto USD card), and corporate collaborations with Auction Ethiopia (managed with Yoseph and Zelalem) to optimize digital spend and regional reach.
