...
- Brand Ambassadorships & Partnerships: Active strategic partnerships and content planning campaigns with local platforms, including corporate collaborations with the Auction Ethiopia team (managed alongside contacts Yoseph and Zelalem) to optimize digital ad spend and regional reach. Also collaborates with Bybit, Ehud AI, HuluPay, LinkPay, Hawi Solutions, Hulugram (the widely popular multipurpose "super app" built on top of the Telegram messaging API as an all-in-one lifestyle, e-commerce, and communication platform in Ethiopia), and Shine Vision (a leading provider of advanced eye medical treatments and optical frame/lens/eyeglass services in Ethiopia).
