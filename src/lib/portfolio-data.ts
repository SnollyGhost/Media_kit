...
- Brand Ambassadorships & Partnerships: Active strategic partnerships and content planning campaigns with local platforms, including corporate collaborations with the Auction Ethiopia team (managed alongside contacts Yoseph and Zelalem) to optimize digital ad spend and regional reach. Also collaborates with Bybit, Ehud AI, HuluPay, LinkPay, Hawi Solutions, Hulugram (the widely popular multipurpose "super app" built on top of the Telegram messaging API as an all-in-one lifestyle, e-commerce, and communication platform in Ethiopia), and Ethiopian Blockchain Week (EBW - the premier Web3 and digital innovation summit in Addis Ababa).
